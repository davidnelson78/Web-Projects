            ...
            <div id="content-wrapper" class="d-flex flex-column">
                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        ...
                        $sql = "INSERT INTO customer VALUES (NULL, $business_id, '$business_name', '$first_name', '$last_name', '$address',
				'$city', '$state', '$zip_code', '$email_address', '$phone_number');";
                        ...
                        ?>
                        <div >
                            <a class="btn btn-primary" href="./customers.php">Back to customers</a>
                        </div>
                    </div>
                    <!-- End of Main Content -->
                </div>
