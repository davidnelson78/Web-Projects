                    ...
                    <div class="container-fluid">
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold text-primary">Add a customer</h6>
                            </div>
                            <div class="card-body">
                                <div class="table-responsive">
                                    ...
                                    ?>method="post">
                                        <div class="form-group">
                                            <input type="text" name="business_id" class="form-control form-control-user" id="exampleInputEmail" placeholder="Business ID" value="<?php
                                            /* Determine if data to keep exists */
                                            if ($_POST['business_id'] != NULL) {
                                                echo "$business_id";
                                            }
                                            ?>"><?php
                                                   /* Determine if field needed */
                                                   if ($_POST['business_id'] == NULL && !$firstpageload) {
                                                       echo "<span class='valid'>* Business ID Required</span><br/>";
                                                   }
                                                   ?>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            /* Determine if data to keep exists */
                                            if ($_POST['business_name'] != NULL) {
                                                echo "$business_name";
                                            }
                                            ?>"><?php
                                                   /* Determine if field needed */
                                                   if ($_POST['business_name'] == NULL && !$firstpageload) {
                                                       echo "<span class='valid'>* Business Name Required</span><br/>";
                                                   }
                                                   ?>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            ?>"><?php
                                                   ...
                                                   if ($_POST['address'] == NULL && !$firstpageload) {
                                                       echo "<span class='valid'>* Address Required</span><br/>";
                                                   }
                                                   ?>
                                        </div>
                                        <div class="form-group row">
                                        ...
                                        <div class="form-group">
                                            ...
                                            ?>"><?php
                                                   ...
                                                   if ($_POST['phone_number'] == NULL && !$firstpageload) {
                                                       echo "<span class='valid'>* Phone Number Required</span><br/>";
                                                   }
                                                   ?>
                                        </div>
                                        <div>
                                            <button class="btn btn-primary" type="submit" >Add this customer</button>
                                        </div>
                                        <br>
                                    </form>
                                    <?php
