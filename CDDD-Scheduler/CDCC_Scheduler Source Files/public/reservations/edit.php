...
if ($updaterequest && !($_SERVER['REQUEST_METHOD'] === 'POST')) {
    ...
    $sql = "SELECT reservation_id, customer_id, venue_id, date_format(start_times, \"%H:%i\") start_time,
       date_format(end_time, \"%H:%i\") end_time, date_format(start_time, \"%Y-%m-%d\") reservation_date
        FROM reservation_request WHERE reservation_id = $updateid";
                    ...
                    <div class="container-fluid">
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold text-primary">Edit reservation</h6>
                            </div>
                            <div class="card-body">
                                <div class="table-responsive">
                                    ...
                                    ?>
                                        ...
                                        <div class="form-group row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    /* Determine if date to keep exists */
                                                    if ($_POST['start-time'] != NULL || ($updaterequest)) {
                                                        echo "$start_time";
                                                    }
                                                    ?>"/><?php
                                                           /* Determine if field needed */
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    /* Determine if date to keep exists */
                                                    if ($_POST['end-time'] != NULL || ($updaterequest)) {
                                                        echo "$end_time";
                                                    }
                                                    ?>"/><?php
                                                           /* Determine if field needed */
                                                           if ($_POST['end_time'] == NULL && !$firstpageload) {
                                        ...
                                        <br>
                                        <div>
                                            <button class="btn btn-primary" type="submit" >Edit this Reservation</button>
                                        </div>
                                        <br>
                                    </form>
                                    ...
                                    ?>
                                    <div >
                                        <a class="btn btn-secondary" href="./reservations.php">Back to reservations</a>
                                    </div>
                                    <br>
                                </div>
                            </div>
