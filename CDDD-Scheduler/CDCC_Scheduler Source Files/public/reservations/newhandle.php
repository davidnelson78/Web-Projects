            ...
            <div id="content-wrapper" class="d-flex flex-column">
                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        ...
                        $ins_starttime = $date . ' ' . $start_time;
                        $ins_endtime = $date . ' ' . $end_time;

                        // SQL to insert form data into database
                        $sql = "INSERT INTO reservation_request VALUES (NULL, '$customer_id', '$venue_id', NULL, '$ins_starttime',
				'$ins_endtime', '1', NULL);";
                        ...
                        ?>
                        <div >
                            <a class="btn btn-primary" href="./reservations.php">Back to reservations</a>
                        </div>
                    </div>
                    <!-- End of Main Content -->
                </div>
